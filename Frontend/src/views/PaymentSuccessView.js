...
import { usePaymentSuccessViewModel } from '../viewmodels/PaymentSuccessViewModel';
import { COLORS, FONTS, SIZES, STRINGS } from '../utils/Constants';

const PaymentSuccessView = ({ navigation }) => {
  const { handleGoBack } = usePaymentSuccessViewModel(navigation);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.title}>{STRINGS.paymentSuccessTitle}</Text>

        <Text style={styles.message}>{STRINGS.paymentSuccessMessage}</Text>
